        ...
        <div className="container">
          ...
          <div>
            <div className="con-box1" data-aos="fade-down-right">
              <p>
                <i className="fas fa-mobile fa-2x"></i> +91-xxxxx-xxxxx
              </p>
            </div>
            <div className="con-box1" data-aos="fade-down-left">
              <p>
                <i className="fas fa-envelope fa-2x"></i> jagrati@iiitdmj.ac.in
              </p>
            </div>
          </div>
          ...
          <div className="con-box2">
            <p>
              <ContactUsIcons
                href="https://www.facebook.com/JAGRATI.IIITDMJ/"
                company="facebook"
                delay="200"
              />
              <ContactUsIcons
                href="https://www.instagram.com/jagrati.iiitdmj/"
                company="instagram"
                delay="550"
              />
              <ContactUsIcons
                href="https://www.youtube.com/channel/UC0VyWk6o3XXGi1oq-XIbbJQ/"
                company="youtube"
                delay="900"
              />
              <ContactUsIcons
                href="https://github.com/garg3133/JagratiWebApp"
                company="github"
                delay="1250"
              />
            </p>
